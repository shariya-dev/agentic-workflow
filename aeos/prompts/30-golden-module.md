...
- `.ai/engineering-guide/<change-id>.md` (guardrails)
...
2. `.ai/golden/<change-id>/golden-module.md` — a written tour of the module:
   what each layer does, the patterns to copy, and the do's and don'ts.
